          ...
          <>
            <div className="text-left mb-5 text-sm">
              ...
              <ul className="list-disc list-inside">
                <li className="mb-1">
                  All percentages in the table represent whether the shape of the
                  API matches against the baseline.
                ...
                <li className="mb-1">
                  Functions that start with an underscore are internal APIs that we
                  are not targeting at the moment.
                </li>
              </ul>
            </div>
